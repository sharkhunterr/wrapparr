...
`,
  ...
  labels: {
    ...
    recordDay: "Expédition record",
    whenYouConsume: "Quand tu",
    consume: "plonges",
    budgetTitle: "Le trésor de",
    yourFilms: "l'océan",
    ratingsTitle: "Tes découvertes",
    worldTitle: "à travers",
    theWorld: "les abysses",
    countriesRepresented: "fosses explorées",
    bestNote: "Perle abyssale",
    worstNote: "Épave oubliée",
    mostExpensive: "Expéditions profondes",
    leastExpensive: "Plongées côtières",
    bestROI: "Meilleur ratio profondeur/découverte",
    avgBudget: "Coût moyen par plongée",
    totalCumulated: "budget total",
    distributionTitle: "Répartition des expéditions",
    budgetPerFilm: "Coût par plongée",
    on: "sur",
    films: "plongées",
    rated: "evaluees",
