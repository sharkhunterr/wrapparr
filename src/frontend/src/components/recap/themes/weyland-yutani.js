...
`,
  ...
  labels: {
    ...
    favoriteDay: "Jour d'activité primaire",
    consumptionTime: "Fenêtre d'analyse",
    goldenMonth: "Mois optimal",
    recordDay: "Pic d'activité",
    whenYouConsume: "Sujet:",
    consume: "en observation",
    budgetTitle: "Coût d'exploitation",
    yourFilms: "des spécimens",
    ratingsTitle: "Évaluation des",
    worldTitle: "déployés sur",
    theWorld: "le secteur",
    countriesRepresented: "zones couvertes",
    bestNote: "Spécimen de classe A",
    worstNote: "Spécimen défectueux",
    mostExpensive: "Budget élevé",
    leastExpensive: "Budget réduit",
    bestROI: "Meilleur retour sur investissement",
    avgBudget: "Coût moyen d'acquisition",
    totalCumulated: "budget total",
    distributionTitle: "Répartition par coût",
    budgetPerFilm: "Coût par spécimen",
    on: "sur",
    films: "spécimens",
    rated: "évalués",
