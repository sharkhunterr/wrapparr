...
`,
  ...
  labels: {
    ...
    theWorld: "le vidéoclub",
    countriesRepresented: "rayons explorés",
    bestNote: "Sélection du staff",
    worstNote: "Fond de bac",
    mostExpensive: "Éditions collector",
    leastExpensive: "Bac à 1F",
    bestROI: "Meilleur rapport qualité/prix",
    avgBudget: "Prix moyen par cassette",
    totalCumulated: "total dépensé",
    distributionTitle: "Répartition du vid\u00e9oclub",
